...
def pregunta_08():
    ...
    """
    columna = tbl0.copy()
    columna["suma"] = tbl0["_c0"] + tbl0["_c2"]
    return columna
...
def pregunta_09():
    ...
    """
    columna = tbl0.copy()
    columna["year"] = [x.split("-")[0] for x in tbl0["_c3"]]
    return columna
...
def pregunta_10():
    ...
    """
    columna = tbl0[["_c1","_c2"]].copy().set_index("_c2").groupby("_c1")
    proc = {g:":".join(sorted([str(x) for x in c])) for g,c in columna.groups.items()}
...
def pregunta_11():
    ...
    39   39    a,d,f
    """
    tabla = tbl1.copy().set_index("_c4").groupby("_c0")
...
def pregunta_12():
    ...
    """
    tabla = tbl2.copy()
    tabla["_c5"] = tabla["_c5a"] + ":" + [str(x) for x in tabla["_c5b"]]
    tb = tabla.drop(["_c5a","_c5b"], axis=1).set_index("_c5").groupby("_c0")
